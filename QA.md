...
3. Reload the extension host or switch workspaces and confirm the latest review result rehydrates into the overview, files view, inline thread annotations, and status bar summary.
